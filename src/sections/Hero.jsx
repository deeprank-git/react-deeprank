      ...
      <div>
        <div className="relative overflow-hidden">
          <img
            src={hero5}
            alt="AI Solutions"
            className="w-full h-120 sm:h-135 lg:h-150 object-cover object-center"
          />
          ...
          <div className="absolute inset-x-0 top-0 flex flex-col items-center text-center px-5 pt-4">
            <p className="text-xs font-bold tracking-[0.22em] text-[#08104A] uppercase my-5 mb-3">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                onClick={open}
                className="inline-flex items-center gap-2 bg-[#08104A] hover:bg-blue-900 text-white px-7 py-3.5 rounded-full font-semibold text-sm transition-all shadow-lg"
              >
                Book a Call <HiArrowRight className="w-4 h-4" />
              </button>
              <button className="inline-flex items-center gap-2 bg-white/80 border-2 border-[#08104A] text-[#08104A] hover:bg-[#08104A] hover:text-white px-7 py-3.5 rounded-full font-semibold text-sm transition-all">
          ...
          {/* Floating stat card */}
          <div
            className="absolute bottom-0 right-0 bg-white px-24 py-4 shadow-2xl border border-gray-100 text-right"
            style={{
              clipPath: "polygon(15% 0%, 100% 0%, 100% 100%, 0% 100%)"
            }}
          >
            <p className="text-5xl font-black text-green-500 leading-none">{count}+</p>
            <p className="text-lg text-black font-medium mt-1">Solution Delivered</p>
          </div>
        </div>
      </div>

      {/* ── Trusted companies ── */}
      <div className="border-y border-gray-100 bg-white mt-8 py-5">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center gap-5 lg:gap-10">

            <div className="shrink-0 text-center sm:text-left">
              <p className="text-[10px] font-bold tracking-widest text-blue-500 uppercase">Trusted by</p>
